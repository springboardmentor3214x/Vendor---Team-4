...
def get_documents(
    ...
    today = date.today()
    documents = db.query(VendorDocument).order_by(VendorDocument.id.desc()).all()
    changed = False
    for document in documents:
        if document.expiry_date and document.expiry_date < today and document.status != DocumentStatus.EXPIRED:
